...
description: Craft or review a 3-minute founder pitch deck and speaker script using the DePitch framework (16 hackathon wins, $2.5M+ raised across teams). Use to build, review, roast, or rehearse a pitch deck, pitch video, demo-day pitch, hackathon submission, or startup-competition pitch — even without saying "pitch deck" (e.g. "help me pitch my project", "I have 3 minutes to convince judges"). Works for any short founder pitch to investors or judges.
---
