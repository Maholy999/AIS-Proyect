---
name: impeccable
description: Use to design, redesign, critique, polish, or otherwise improve a frontend interface (websites, dashboards, product UI, forms, onboarding, empty states). Covers visual hierarchy, information architecture, accessibility, typography, spacing, layout, color, motion, micro-interactions, UX copy, error states, and reusable design systems. Also use to make bland designs bolder or loud designs quieter. Not for backend-only or non-UI tasks.
---
